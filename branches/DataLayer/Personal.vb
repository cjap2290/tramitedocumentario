...
Public MustInherit Class _Personal
	...
	Protected class Parameters 
		...
		Public Shared ReadOnly Property IdPersona As OleDbParameter
			Get
				Return New OleDbParameter("@IdPersona", OleDbType.Char, 7)
			End Get
		End Property
		
		Public Shared ReadOnly Property FechaIng As OleDbParameter
			Get
				Return New OleDbParameter("@FechaIng", OleDbType.DBTimeStamp, 0)
			End Get
		End Property
		
		Public Shared ReadOnly Property IdCargo As OleDbParameter
			Get
				Return New OleDbParameter("@IdCargo", OleDbType.Char, 2)
			End Get
		End Property
		
		Public Shared ReadOnly Property IdArea As OleDbParameter
			Get
				Return New OleDbParameter("@IdArea", OleDbType.Char, 2)
			End Get
		End Property
		
		Public Shared ReadOnly Property FechaSal As OleDbParameter
			Get
				Return New OleDbParameter("@FechaSal", OleDbType.DBTimeStamp, 0)
			End Get
		End Property
		
		Public Shared ReadOnly Property IngMensual As OleDbParameter
			Get
				Return New OleDbParameter("@IngMensual", OleDbType.Currency, 0)
			End Get
		End Property
		
		Public Shared ReadOnly Property Idagencia As OleDbParameter
			Get
				Return New OleDbParameter("@Idagencia", OleDbType.Char, 2)
			End Get
		End Property
		
		Public Shared ReadOnly Property IdEstPers As OleDbParameter
			Get
				Return New OleDbParameter("@IdEstPers", OleDbType.Char, 4)
			End Get
		End Property
		
		Public Shared ReadOnly Property IdUser As OleDbParameter
			Get
				Return New OleDbParameter("@IdUser", OleDbType.Char, 6)
			End Get
		End Property
		
		Public Shared ReadOnly Property FecPro As OleDbParameter
			Get
				Return New OleDbParameter("@FecPro", OleDbType.DBTimeStamp, 0)
			End Get
		End Property
		
		Public Shared ReadOnly Property Hora As OleDbParameter
			Get
				Return New OleDbParameter("@Hora", OleDbType.Char, 8)
			End Get
		End Property
		
		Public Shared ReadOnly Property IdEstPer As OleDbParameter
			Get
				Return New OleDbParameter("@IdEstPer", OleDbType.Char, 2)
			End Get
		End Property
		
		Public Shared ReadOnly Property FormaMarcado As OleDbParameter
			Get
				Return New OleDbParameter("@FormaMarcado", OleDbType.Char, 4)
			End Get
		End Property
