...
Public Class Personal 
    ...
    Private nIdPersonal As Integer
    Public Property pIdPersonal() As Integer
        Get
            Return nIdPersonal
        End Get
    ...
    Public Function obtCargoPersonal(ByVal sIdpersona As String) As Boolean
        Try
            Where.IdPersona.Value = CType(sIdpersona, Integer)
            Where.IdPersona.Operator = WhereParameter.Operand.Equal
